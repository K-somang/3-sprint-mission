...
// // 공통 댓글 목록 조회 함수
// const getComments = async (parentType: string, parentId: string, req: Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>, res: Response<any, Record<string, any>, number>) => {
...
// // 중고마켓 댓글 목록 조회
// export const getProductComments: RequestHandler = async (req, res, next) => {
//   try {
